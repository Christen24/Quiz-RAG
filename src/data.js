...
export const genres = [
  {
    ...
    difficulty: "Adaptive",
    coverage: "128 docs",
    description: "Evidence-rich questions with grounded scientific citations.",
    accent: "from-cyan-400/60 to-indigo-500/60",
  },
  {
    id: "history",
    name: "World History",
    ...
    coverage: "94 docs",
    description: "Chronologies, source excerpts, and comparative analysis.",
  ...
  },
  {
    ...
    difficulty: "Advanced",
    coverage: "156 docs",
    description: "Modern AI concepts with retrieval-backed explanations.",
    accent: "from-indigo-400/60 to-fuchsia-400/50",
  },
  {
    id: "literature",
    name: "Literature",
    ...
    coverage: "73 docs",
    description: "Themes, authorship, and contextual interpretation.",
  ...
  },
  {
    ...
    difficulty: "Adaptive",
    coverage: "81 docs",
    description: "Case-study prompts with performance insight overlays.",
  ...
  },
  {
    ...
    difficulty: "Expert",
    coverage: "112 docs",
    description: "Astrophysics, missions, and futuristic reasoning tasks.",
